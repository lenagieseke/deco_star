...
% % LG: I actually agree with Paul and think this could be skipped in the abstract after all.
...
% % \pa{Everything before this is more like an introduction, not an abstract.  Suggest deleting.}
% We review recent methods in 2D creative pattern generation and their control mechanisms, with particular focus on procedural methods.
...
% %\pa{I think you could introduce aesthetics in the next sentence.}\legie{I rather stay away from the term "aesthetic" as it is hard to define}
% Interactive pattern generation is a complex design problem. While the repetitive nature of a pattern is well-matched with algorithmic creation, for adaptable and inventive designs control mechanisms that go beyond automation need to be given to artists. We classify control for a creation process as (1) how is input given by an artist, (2) what type of content does an artist input, (3) where does the input have an effect spatially on the canvas and (4) when can input be given in the timeline of the creation process? Next, we categorize control mechanisms on an algorithmic level and on their input modes on exemplars, parameterization, handling, filling, guiding, and placing interactions.
% We organize our analysis of the state of the art along these categories as well as on the pattern design features they enable, such as repetition, frames, curves, directionality and single visual accents. The focus on design features allows for the integration and comparison of various techniques, such as procedural and data-driven approaches. For a better understanding of the potential of the current techniques for creative creation and for making such an investigation more manageable, we motivate our discussion on the creative means of navigation, transparency, variation, and stimulation. 
% We conclude our review by identifying possible new directions that have the potential to inspire innovation for artist-centered creation processes and algorithms.

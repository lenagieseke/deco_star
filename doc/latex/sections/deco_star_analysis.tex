...
\colorbox{red} {Todo: Add \cite{gieseke_2014_ipr, tu_2020_cct, guehl_2020_stu}}

Drawing Tiles:

\colorbox{red} {Todo: Add \cite{bian_2018_tpd, guehl_2020_stu, derouet_2019_gsw}}
...
\colorbox{red} {Todo: Add \cite{gieseke_2017_ooo}}
...
\colorbox{red} {Todo: Add \cite{talton_2009_emw}}
...
\label{para:commonly_element_arrangements_example}
...
\colorbox{red} {Todo: Sort and add \cite{almeraj_2013_pgt, landes_2013_asm, davison_2019_ief, peihan_2019_pps, chen_2019_mpc, li_2019_aqp}}
...
\colorbox{red} {Todo: Add \cite{saputra_2018_rde, hsu_2018_bef, davison_2019_ief, hsu_2020_aef}}
...
\colorbox{red} {Todo: Add \cite{alvarez_2019_ido}}
...
\colorbox{red} {Todo: Add \cite{pedersen_2006_ola}}

In section \Cref{subpara:analysis_rulebased_sketchbased_datadriven} we already discussed data-driven techniques for creating repetitive structures with sketching. ~\cite{kazi_2012_vit, xing_2014_apr, xing_2015_aha} can be similarly used to sketch parts of a pattern directly.

\subsection{Connections, Branches and Directionality}
\label{subsec:analysis_connections_branches_and_directionality}

\begin{itemize}
    \item Example-based branching: \colorbox{red} {Todo: Add \cite{guo_2020_ipm}, as inspiration?: \cite{guerin_2017_ieb}}
    \item Data-driven directionality: \colorbox{red} {Todo: Add \cite{xing_2016_eit, hu_2019_ssf}}
    \item Street-Modeling: \colorbox{red} {Todo: Add \cite{chu_2019_ntg}}, Plants: \colorbox{red} {Todo: Add \cite{haedrich_2017_ima}}
\end{itemize}
...
In section TODO: about element arrangements discussed in detail, \citeauthor*{ijiri_2008_aeb}~\cite{ijiri_2008_aeb} employ vector fields to define the overall growth direction and alignment of elements within an example-guided arrangement. \citeauthor*{saputra_2017_ffo}~\cite{saputra_2017_ffo} optimize a flow-based ornamental packing of elements into a two-dimensional outline. 

In section TODO: about rule-based pattern discussed in detail, \citeauthor*{yuanyuan_2011_gso}~\cite{yuanyuan_2011_gso} present a shape grammar that is guided by either a vector or tensor field.
...
TODO (still applicable?): The discussion of this section is closely related to the data-driven sketch-based techniques, and it shows a further promising approach for integrating procedural modeling functionalities into a data-driven process. 
...
\colorbox{red} {Todo: Add \cite{mech_2012_tdf, gieseke_2017_ooo, jacobs_2017_sep, jacobs_2018_dbe, li_2020_sva}}
...
\colorbox{red} {Todo: Add \cite{heer_2019_apa}}
...
\colorbox{red} {Todo: Add \cite{joppi_2019_tri}}

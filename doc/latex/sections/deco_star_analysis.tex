...
\insertref[inline]{\cite{jacobs_2017_sep, jacobs_2018_dbe, li_2020_sva, tu_2020_cct}}
...
%     \label{table:control_mechanisms}
%     \caption[Control mechanisms in the state of the art]{Recent techniques are sorted by design areas and visual features they enable. For each work it is analysed and indicated which specific control mechanisms they offer.  \colorbox{red} {Will update table last.}}
% \end{figure*}

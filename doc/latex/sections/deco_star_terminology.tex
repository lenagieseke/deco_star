...
\textbf{Ornament:} Constitutes a specific type of decor adhering to certain design rules, such as order, hierarchal structures, space adaptation and visual contrast and accents (\Cref{subsubsec:ornamentation}).
...
\textbf{Expressiveness:} Refers in this work to the size, the variability and the openness of a design space as in detail discussed in~\Cref{ec:creativ_means}. Expressiveness is commonly used in the context of creative controls - however, usually without a clear understanding of its meaning.

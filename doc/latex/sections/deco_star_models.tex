...
In recent years, machine learning has been introduced into procedural content generation with the same impact as in all other computer science fields~\cite{summerville_2017_pcg}. The potential of machine learning techniques in regard to creative pattern generation seems almost limitless and is further discussed as outlook (\Cref{subsubsec:outlook_machinelearning}~\nameref{subsubsec:outlook_machinelearning}).
...
\centering
    ...
    \caption[Islamic and Celtic ornamental designs]{Examples of traditional Islamic (left) and Celtic ornamental designs. Image sources: [12, 13].}
